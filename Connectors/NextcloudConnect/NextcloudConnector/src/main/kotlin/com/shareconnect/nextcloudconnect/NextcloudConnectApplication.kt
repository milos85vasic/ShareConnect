...
class NextcloudConnectApplication : Application() {
    ...
    private fun observeLanguageChanges() {
        applicationScope.launch {
            languageSyncManager.languageChangeFlow.collect { languageData ->
                ...
                LocaleHelper.persistLanguage(this@NextcloudConnectApplication, languageData.languageCode)
            }
        }
    }
    ...
    private fun initializeProfileSync() {
        ...
        profileSyncManager = ProfileSyncManager.getInstance(
            ...
            appName = "NextcloudConnect",
            appVersion = packageInfo.versionName ?: "1.0.0",
            clientTypeFilter = "CLOUD_STORAGE"  // NextcloudConnect only syncs cloud storage profiles
        )
    ...
    private fun initializeRSSSync() {
        ...
        rssSyncManager = RSSSyncManager.getInstance(
            ...
            appName = "NextcloudConnect",
            appVersion = packageInfo.versionName ?: "1.0.0",
            clientTypeFilter = "CLOUD_STORAGE"  // NextcloudConnect syncs cloud storage RSS feeds
        )
