...
import com.shareconnect.nextcloudconnect.ui.MainActivity
...
/**
 * Automation test suite for NextcloudConnect application.
 * Tests basic app launch and functionality.
 */
@RunWith(AndroidJUnit4::class)
class NextcloudConnectAutomationTest {
    ...
    fun testAppLaunches() {
        ...
        assertEquals("com.shareconnect.nextcloudconnect.debug", appContext.packageName)
