...
/**
 * SyncthingConnect Application
 * P2P file synchronization connector
 */
    ...
    private fun observeLanguageChanges() {
        applicationScope.launch {
            languageSyncManager.languageChangeFlow.collect { languageData ->
                ...
                LocaleHelper.persistLanguage(this@SyncthingConnectApplication, languageData.languageCode)
            }
        }
    }
