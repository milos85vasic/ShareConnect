...
/**
 * Main activity for PaperlessNGConnect
 * Handles security access, onboarding, and main UI
 */
class MainActivity : ComponentActivity() {
    ...
    private fun showSecurityAccessDialog() {
        ...
        builder.setMessage("Please enter your PIN to access PaperlessNGConnect")
...
fun PaperlessNGConnectContent() {
    Column(
        ...
        Text(
            text = "Connect to your Paperless-ngx Document Management System",
        ...
        Text(
            text = "• Document management and search\n" +
        ...
        Spacer(modifier = Modifier.height(32.dp))
        Text(
            text = "Full UI implementation in progress!",
