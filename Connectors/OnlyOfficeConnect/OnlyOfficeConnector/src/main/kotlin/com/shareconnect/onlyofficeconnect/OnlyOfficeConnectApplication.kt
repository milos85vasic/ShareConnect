...
class OnlyOfficeConnectApplication : Application() {
    ...
    private fun observeLanguageChanges() {
        applicationScope.launch {
            languageSyncManager.languageChangeFlow.collect { languageData ->
                ...
                LocaleHelper.persistLanguage(this@OnlyOfficeConnectApplication, languageData.languageCode)
            }
        }
    }
    ...
    private fun initializeProfileSync() {
        ...
        profileSyncManager = ProfileSyncManager.getInstance(
            ...
            appName = "OnlyOfficeConnect",
            appVersion = packageInfo.versionName ?: "1.0.0",
            clientTypeFilter = "DOCUMENT_EDITOR"  // OnlyOfficeConnect only syncs document editor profiles
        )
    ...
    private fun initializeRSSSync() {
        ...
        rssSyncManager = RSSSyncManager.getInstance(
            ...
            appName = "OnlyOfficeConnect",
            appVersion = packageInfo.versionName ?: "1.0.0",
            clientTypeFilter = "DOCUMENT_EDITOR"  // OnlyOfficeConnect syncs document editor RSS feeds
        )
