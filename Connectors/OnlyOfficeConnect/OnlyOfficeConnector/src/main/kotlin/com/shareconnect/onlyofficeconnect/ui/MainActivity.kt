...
class MainActivity : ComponentActivity() {
    ...
    private fun showSecurityAccessDialog() {
        ...
        builder.setMessage("Please enter your PIN to access OnlyOfficeConnect")
...
fun OnlyOfficeConnectContent() {
    Column(
        ...
        Text(
            text = "Connect to your ONLYOFFICE Document Server",
        ...
        Text(
            text = "Edit documents, spreadsheets, and presentations\nwith real-time collaboration",
