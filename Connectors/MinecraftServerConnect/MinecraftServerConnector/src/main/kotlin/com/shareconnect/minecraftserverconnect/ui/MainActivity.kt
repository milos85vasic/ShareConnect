...
class MainActivity : ComponentActivity() {
    ...
    private fun showSecurityAccessDialog() {
        ...
        builder.setMessage("Please enter your PIN to access MinecraftServerConnect")
...
@Composable
fun MinecraftServerConnectContent() {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Text(
            text = "Manage your Minecraft Server via RCON",
        ...
        Spacer(modifier = Modifier.height(16.dp))
        Text(
            text = "Full UI implementation coming soon!",
