...
class MinecraftServerConnectApplication : Application() {
    ...
    private fun observeLanguageChanges() {
        applicationScope.launch {
            languageSyncManager.languageChangeFlow.collect { languageData ->
                ...
                LocaleHelper.persistLanguage(this@MinecraftServerConnectApplication, languageData.languageCode)
            }
        }
    }
    ...
    private fun initializeThemeSync() {
        ...
        themeSyncManager = ThemeSyncManager.getInstance(
            context = this,
            appId = packageName,
            appName = "MinecraftServerConnect",
    ...
    private fun initializeProfileSync() {
        ...
        profileSyncManager = ProfileSyncManager.getInstance(
            ...
            appName = "MinecraftServerConnect",
            appVersion = packageInfo.versionName ?: "1.0.0",
            clientTypeFilter = "GAME_SERVER"  // MinecraftServerConnect only syncs game server profiles
        )
    ...
    private fun initializeRSSSync() {
        ...
        rssSyncManager = RSSSyncManager.getInstance(
            ...
            appName = "MinecraftServerConnect",
            appVersion = packageInfo.versionName ?: "1.0.0",
            clientTypeFilter = "GAME_SERVER"  // MinecraftServerConnect syncs game server RSS feeds
        )
