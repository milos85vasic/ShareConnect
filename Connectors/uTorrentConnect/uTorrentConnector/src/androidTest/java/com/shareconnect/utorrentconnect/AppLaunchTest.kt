...
/**
 * Automation test to verify that the uTorrentConnect application loads and starts
...
class AppLaunchTest {
    ...
    fun app_launches_without_crashing() {
        ...
        val application = context.applicationContext as uTorrentRemote
        assertNotNull("uTorrentRemote should not be null", application)
