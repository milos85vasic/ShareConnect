...
import com.shareconnect.utorrentconnect.databinding.DownloadLocationDialogBinding;
...
public class DownloadLocationDialogFragment extends DialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        app = uTorrentRemote.getApplication(requireContext());
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String defaultDownloadDir = uTorrentRemote.getInstance().defaultDownloadDir;
            ...
            addButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (freeSpace != null && freeSpace.getSizeInBytes() >= 0
                            || uTorrentRemote.getInstance().isFreeSpaceCheckDisabled()) {
                        notifyListener();
                        dialog.dismiss();
                    } else {
    ...
    private void updateFreeSpaceInfo() {
        ...
        if (!uTorrentRemote.getInstance().isFreeSpaceCheckDisabled()) {
                    ...
                    if (dialog != null) {
                        ...
                        if (freeSpace.getSizeInBytes() >= 0) {
                            ...
                            clickify(binding.freeSpaceText, useDefaultText, new ClickSpan.OnClickListener() {
                                @Override
                                public void onClick() {
                                    uTorrentRemote app = (uTorrentRemote) requireActivity().getApplicationContext();
