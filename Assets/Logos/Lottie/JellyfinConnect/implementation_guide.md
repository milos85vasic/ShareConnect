# JellyfinConnect Lottie Animation Implementation

## Animation Details
- **Concept**: Jellyfish swimming with media symbols
- **Duration**: 3000ms
- **Resolution**: 512x512
- **Framerate**: 60fps
...
2. **500-1500ms**: JellyfinConnect icon fades in with application-specific animation
