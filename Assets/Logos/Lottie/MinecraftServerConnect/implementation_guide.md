# MinecraftServerConnect Lottie Animation Implementation

## Animation Details
- **Concept**: Game server starting up with block animation
- **Duration**: 3000ms
- **Resolution**: 512x512
- **Framerate**: 60fps
...
2. **500-1500ms**: MinecraftServerConnect icon fades in with application-specific animation
