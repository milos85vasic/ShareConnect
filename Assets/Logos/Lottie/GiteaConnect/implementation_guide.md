# GiteaConnect Lottie Animation Implementation

## Animation Details
- **Concept**: Code repository syncing with branch movement
- **Duration**: 3000ms
- **Resolution**: 512x512
- **Framerate**: 60fps
...
2. **500-1500ms**: GiteaConnect icon fades in with application-specific animation
