# HomeAssistantConnect Lottie Animation Implementation

## Animation Details
- **Concept**: Smart home waking up with connected devices
- **Duration**: 3000ms
- **Resolution**: 512x512
- **Framerate**: 60fps
...
2. **500-1500ms**: HomeAssistantConnect icon fades in with application-specific animation
