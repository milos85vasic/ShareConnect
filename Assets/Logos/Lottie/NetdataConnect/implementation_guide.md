# NetdataConnect Lottie Animation Implementation

## Animation Details
- **Concept**: Live dashboard metrics animating
- **Duration**: 3000ms
- **Resolution**: 512x512
- **Framerate**: 60fps
...
2. **500-1500ms**: NetdataConnect icon fades in with application-specific animation
