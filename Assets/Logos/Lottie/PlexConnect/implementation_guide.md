# PlexConnect Lottie Animation Implementation

## Animation Details
- **Concept**: Media waves flowing with play symbol
- **Duration**: 3000ms
- **Resolution**: 512x512
- **Framerate**: 60fps
...
2. **500-1500ms**: PlexConnect icon fades in with application-specific animation
