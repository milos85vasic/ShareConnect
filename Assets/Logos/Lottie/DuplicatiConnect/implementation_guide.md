# DuplicatiConnect Lottie Animation Implementation

## Animation Details
- **Concept**: Backup process with data streams
- **Duration**: 3000ms
- **Resolution**: 512x512
- **Framerate**: 60fps
...
2. **500-1500ms**: DuplicatiConnect icon fades in with application-specific animation
