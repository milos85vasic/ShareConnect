...
fun createColorSchemeFromTheme(themeData: ThemeData, isDarkMode: Boolean): androidx.compose.material3.ColorScheme {
    return if (themeData.isCustom && themeData.customPrimary != null) {
        ...
        if (isDarkMode) {
            darkColorScheme(
                primary = Color(themeData.customPrimary),
                onPrimary = Color(themeData.customOnPrimary ?: 0xFFFFFFFF),
                primaryContainer = Color(themeData.customPrimaryContainer ?: themeData.customPrimary),
                onPrimaryContainer = Color(themeData.customOnPrimaryContainer ?: 0xFF1A0000),
                secondary = Color(themeData.customSecondary ?: themeData.customPrimary),
                onSecondary = Color(themeData.customOnSecondary ?: 0xFFFFFFFF),
                secondaryContainer = Color(themeData.customSecondaryContainer ?: themeData.customSecondary ?: themeData.customPrimary),
                ...
                errorContainer = Color(themeData.customErrorContainer ?: 0xFFFFDAD6),
                onErrorContainer = Color(themeData.customOnErrorContainer ?: 0xFF410002),
                background = Color(themeData.customBackground ?: if (isDarkMode) 0xFF141218 else 0xFFFFFBFE),
                onBackground = Color(themeData.customOnBackground ?: if (isDarkMode) 0xFFE6E1E5 else 0xFF1C1B1F),
                surface = Color(themeData.customSurface ?: if (isDarkMode) 0xFF141218 else 0xFFFFFBFE),
                onSurface = Color(themeData.customOnSurface ?: if (isDarkMode) 0xFFE6E1E5 else 0xFF1C1B1F),
                surfaceVariant = Color(themeData.customSurfaceVariant ?: if (isDarkMode) 0xFF49454F else 0xFFE7E0EC),
                onSurfaceVariant = Color(themeData.customOnSurfaceVariant ?: if (isDarkMode) 0xFFCAC4D0 else 0xFF49454F),
                surfaceTint = Color(themeData.customSurfaceTint ?: themeData.customPrimary),
                outline = Color(themeData.customOutline ?: if (isDarkMode) 0xFF938F99 else 0xFF79747E),
                outlineVariant = Color(themeData.customOutlineVariant ?: if (isDarkMode) 0xFF49454F else 0xFFCAC4D0),
                scrim = Color(themeData.customScrim ?: 0xFF000000),
                surfaceBright = Color(themeData.customSurfaceBright ?: if (isDarkMode) 0xFF3B383E else 0xFFFFFBFE),
                surfaceDim = Color(themeData.customSurfaceDim ?: if (isDarkMode) 0xFF141218 else 0xFFDED8E1),
                surfaceContainer = Color(themeData.customSurfaceContainer ?: if (isDarkMode) 0xFF211F26 else 0xFFF3EDF7),
                surfaceContainerHigh = Color(themeData.customSurfaceContainerHigh ?: if (isDarkMode) 0xFF2B2930 else 0xFFECE6F0),
                surfaceContainerHighest = Color(themeData.customSurfaceContainerHighest ?: if (isDarkMode) 0xFF36343B else 0xFFE6E0E9),
                surfaceContainerLow = Color(themeData.customSurfaceContainerLow ?: if (isDarkMode) 0xFF1C1B1F else 0xFFF7F2FA),
                surfaceContainerLowest = Color(themeData.customSurfaceContainerLowest ?: if (isDarkMode) 0xFF0F0D13 else 0xFFFFFFFF)
            )
        } else {
            lightColorScheme(
                primary = Color(themeData.customPrimary),
                ...
                errorContainer = Color(themeData.customErrorContainer ?: 0xFFFFDAD6),
                onErrorContainer = Color(themeData.customOnErrorContainer ?: 0xFF410002),
                background = Color(themeData.customBackground ?: 0xFFFFFBFE),
                onBackground = Color(themeData.customOnBackground ?: 0xFF1C1B1F),
                surface = Color(themeData.customSurface ?: 0xFFFFFBFE),
                onSurface = Color(themeData.customOnSurface ?: 0xFF1C1B1F),
                surfaceVariant = Color(themeData.customSurfaceVariant ?: 0xFFE7E0EC),
                onSurfaceVariant = Color(themeData.customOnSurfaceVariant ?: 0xFF49454F),
                surfaceTint = Color(themeData.customSurfaceTint ?: themeData.customPrimary),
                outline = Color(themeData.customOutline ?: 0xFF79747E),
                outlineVariant = Color(themeData.customOutlineVariant ?: 0xFFCAC4D0),
                scrim = Color(themeData.customScrim ?: 0xFF000000),
                surfaceBright = Color(themeData.customSurfaceBright ?: 0xFFFFFBFE),
                surfaceDim = Color(themeData.customSurfaceDim ?: 0xFFDED8E1),
                surfaceContainer = Color(themeData.customSurfaceContainer ?: 0xFFF3EDF7),
                surfaceContainerHigh = Color(themeData.customSurfaceContainerHigh ?: 0xFFECE6F0),
                surfaceContainerHighest = Color(themeData.customSurfaceContainerHighest ?: 0xFFE6E0E9),
                surfaceContainerLow = Color(themeData.customSurfaceContainerLow ?: 0xFFF7F2FA),
                surfaceContainerLowest = Color(themeData.customSurfaceContainerLowest ?: 0xFFFFFFFF)
            )
        }
    } else {
